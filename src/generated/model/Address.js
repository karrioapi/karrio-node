...
class Address {
     ...
     * @param country_code {module:model/Address.CountryCodeEnum} The address country code
     */
    constructor(country_code) { 
        
        Address.initialize(this, country_code);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('validation')) {
                obj['validation'] = AddressValidation.constructFromObject(data['validation']);
            }
        }
        return obj;
    }
 ...
 */
Address.prototype['federal_tax_id'] = undefined;

/**
 * The party state id
 * @member {String} state_tax_id
 */
Address.prototype['state_tax_id'] = undefined;

/**
 *  attention to  **(required for shipment purchase)** 
 * @member {String} person_name
 */
Address.prototype['person_name'] = undefined;
 ...
 * @member {module:model/Address.CountryCodeEnum} country_code
 */
 ...
 */
Address.prototype['state_code'] = undefined;
 ...
 * @default false
 */
Address.prototype['residential'] = false;
 ...
 * @default false
 */
Address.prototype['validate_location'] = false;

/**
 * @member {module:model/AddressValidation} validation
 */
Address.prototype['validation'] = undefined;
