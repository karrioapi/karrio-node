...
class References {
     ...
     */
    constructor(APP_NAME, APP_VERSION, countries, currencies, carriers, customs_content_type, incoterms, states, services, service_names, options, option_names, package_presets, packaging_types, payment_types) { 
        
        References.initialize(this, APP_NAME, APP_VERSION, countries, currencies, carriers, customs_content_type, incoterms, states, services, service_names, options, option_names, package_presets, packaging_types, payment_types);
    }
     ...
     */
    static initialize(obj, APP_NAME, APP_VERSION, countries, currencies, carriers, customs_content_type, incoterms, states, services, service_names, options, option_names, package_presets, packaging_types, payment_types) { 
