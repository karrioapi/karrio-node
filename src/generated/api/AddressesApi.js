...
export default class AddressesApi {
    ...
    */
     ...
     * @callback module:api/AddressesApi~discardCallback
     * @param {String} error Error message, if any.
     ...
     * Discard an address.
     * @param {String} id 
     * @param {module:api/AddressesApi~discardCallback} callback The callback function, accepting three arguments: error, data, response
