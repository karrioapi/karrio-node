...
export default class ProxyApi {
    ...
    */
     ...
     * @callback module:api/ProxyApi~fetchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ProxyApi~fetchCallback} callback The callback function, accepting three arguments: error, data, response
